...
class PPAdd extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ae1 = e1.toUPP(locals);
        UPPExpr ae2 = e2.toUPP(locals);
        return new UPPAdd(ae1,ae2);
    }//toUPP
...
class PPSub extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr se1 = e1.toUPP(locals);
        UPPExpr se2 = e2.toUPP(locals);
        return new UPPSub(se1,se2);
    }//toUPP
...
class PPMul extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr me1 = e1.toUPP(locals);
        UPPExpr me2 = e2.toUPP(locals);
        return new UPPMul(me1,me2);
    }//toUPP
...
class PPDiv extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr de1 = e1.toUPP(locals);
        UPPExpr de2 = e2.toUPP(locals);
        return new UPPDiv(de1,de2);
    }//toUPP
...
class PPOr extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr oe1 = e1.toUPP(locals);
        UPPExpr oe2 = e2.toUPP(locals);
        return new UPPOr(oe1,oe2);
    }//toUPP
...
class PPEq extends PPBinOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        UPPExpr ee1 = e1.toUPP(locals);
        UPPExpr ee2 = e2.toUPP(locals);
        return new UPPEq(ee1,ee2);
    }//toUPP
...
class PPFun extends PPDef {
    ...
    UPPDef toUPP() {
        ...
        nlocals.add(name); //NOTE very probably a mistake
        nall.add(name); //NOTE possibly a mistake
